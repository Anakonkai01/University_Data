CREATE DATABASE QuanLyChoThueToChucSuKien2;
GO
USE QuanLyChoThueToChucSuKien2;
GO
...
CREATE TABLE SuKien (
    ...
    MaHD VARCHAR(10) NOT NULL UNIQUE, -- Mỗi sự kiện phải tham chiếu đến một hợp đồng
...
CREATE TABLE PhanCong (
    ...
    VaiTro NVARCHAR(100),
    CONSTRAINT FK_PhanCong_SuKien FOREIGN KEY (MaSK) REFERENCES SuKien(MaSK),
